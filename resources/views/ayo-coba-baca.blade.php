...
<body class="flex min-h-screen items-center justify-center bg-gray-800 p-4">
    ...
    <div
        class="bg-grid-pattern relative flex aspect-[1/1.41] w-full max-w-xl flex-col items-center justify-between overflow-hidden rounded-xl border-8 border-black p-6 shadow-2xl sm:p-8"
    >
        <!-- Judul Atas -->
        ...
        <div class="my-auto flex w-full flex-col items-center space-y-5">
            ...
            <div
                class="custom-card flex w-full items-center justify-around px-8 py-5 shadow-sm"
            >
                <span
                    class="header-word ml-2 text-5xl font-extrabold tracking-tight sm:text-6xl"
                >
                    bola
                </span>
                ...
                <div class="relative mr-2 flex items-center justify-center">
                    ...
                    <div
                        class="absolute -bottom-1 h-11 w-32 rounded-[50%] bg-[#95c11f]"
                    ></div>
                    <!-- SVG Bola Sepak -->
            ...
            <div
                class="custom-card flex w-full flex-col space-y-6 px-6 py-8 text-center text-2xl shadow-sm"
            >
                <p class="leading-tight font-extrabold tracking-wide text-black">bola kecil meluncur di atas meja</p>
                <p class="leading-tight font-extrabold tracking-wide text-black">bola sepak dijaga oleh kipper di gawang</p>
                <p class="leading-tight font-extrabold tracking-wide text-black">bola basket dilempar ke keranjang tinggi</p>
