...
<div class="fixed w-[400px] h-[400px] rounded-full opacity-30 z-0"
     style="background:radial-gradient(circle, #ff6b6b, transparent);top:-100px;left:-150px;animation:float 8s ease-in-out infinite"></div>
<div class="fixed w-[300px] h-[300px] rounded-full opacity-30 z-0"
     style="background:radial-gradient(circle, #a78bfa, transparent);top:50%;right:-100px;animation:float 10s ease-in-out infinite reverse"></div>
    ...
    <div class="text-center relative z-10 max-w-2xl animate-slideUp">
        ...
        <div class="relative w-full max-w-[550px] h-[380px] mx-auto mb-12 z-10 flex items-center justify-center" style="perspective: 2000px">
            ...
            <div class="relative w-full h-full flex animate-float" style="transform: rotateX(15deg) rotateY(-6deg) rotateZ(-1deg); transform-style: preserve-3d;">
                ...
                <div class="absolute left-0 top-0 w-1/2 h-full" style="transform-origin: right center; transform: rotateY(14deg); transform-style: preserve-3d;">
                    {{-- Left Cover --}}
                    <div class="absolute inset-0 bg-gradient-to-l from-violet-700 to-purple-600 rounded-l-2xl border-l-[6px] border-y-[3px] border-violet-800"
                    ...
                    {{-- Left Top Page --}}
                    <div
                        class="absolute right-[8px] top-[6px] bottom-[6px] left-[10px] bg-gradient-to-r from-stone-50 to-white rounded-l-md p-6 flex flex-col justify-between select-none shadow-[inset_-10px_0_15px_rgba(0,0,0,0.05)]"
                ...
                <div class="absolute right-0 top-0 w-1/2 h-full" style="transform-origin: left center; transform: rotateY(-14deg); transform-style: preserve-3d;">
                    {{-- Right Cover --}}
                    <div class="absolute inset-0 bg-gradient-to-r from-violet-700 to-purple-600 rounded-r-2xl border-r-[6px] border-y-[3px] border-violet-800"
                         style="box-shadow: 15px 20px 35px rgba(0, 0, 0, 0.35);">
                        {{-- Cardboard thickness effect --}}
                    ...
                    {{-- Right Top Page --}}
                    <div
                        class="absolute left-[8px] top-[6px] bottom-[6px] right-[10px] bg-gradient-to-l from-stone-50 to-white rounded-r-md p-6 flex flex-col justify-between select-none shadow-[inset_10px_0_15px_rgba(0,0,0,0.05)]"
                        style="transform: translateZ(12px);">
                        {{-- Content --}}
                        <div class="relative z-10 flex flex-col h-full justify-between items-center text-center pt-2">
        ...
        <div class="flex gap-5 justify-center flex-wrap">
            <a href="{{ route('belajar.index') }}"
               class="bg-gradient-to-r from-red-400 to-orange-400 text-white px-10 py-5 text-[1.2rem] font-extrabold rounded-full no-underline shadow-xl hover:-translate-y-1 hover:scale-105 transition-all inline-flex items-center gap-3"
               style="box-shadow:0 10px 30px rgba(255,107,107,0.3)">
                🎓 Mulai Belajar
            </a>
            <a href="{{ route('games.index') }}"
               class="bg-gradient-to-r from-violet-500 to-purple-400 text-white px-10 py-5 text-[1.2rem] font-extrabold rounded-full no-underline shadow-xl hover:-translate-y-1 hover:scale-105 transition-all inline-flex items-center gap-3"
