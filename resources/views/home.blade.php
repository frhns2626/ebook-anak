...
<body
    class="min-h-screen overflow-x-hidden bg-gradient-to-b from-yellow-200 via-emerald-200 to-lime-200 font-['Nunito',sans-serif]"
>
    {{-- Floating decorations --}}
    <div class="animate-float fixed top-[15%] left-[10%] z-10 text-[3rem]">
        ⭐
    </div>
    <div
        class="animate-float fixed top-[20%] right-[15%] z-10 text-[3rem]"
        style="animation-delay: 0.5s"
    >
        ✨
    </div>
    <div
        class="animate-float fixed bottom-[25%] left-[8%] z-10 text-[3rem]"
        style="animation-delay: 1s"
    >
        🌟
    </div>
    <div
        class="animate-float fixed right-[10%] bottom-[20%] z-10 text-[3rem]"
        style="animation-delay: 0.3s"
    >
        💫
    </div>
    <div
        class="animate-float-slow fixed top-[35%] left-[5%] z-10 text-[3rem]"
        style="animation-delay: 1.5s"
    >
        🎈
    </div>
    <div
        class="animate-float fixed top-[40%] right-[8%] z-10 text-[3rem]"
    ...
    ></div>
    {{-- Characters --}}
    <div class="animate-wiggle fixed bottom-[15%] left-[5%] z-10 text-[4rem]">
        🐰
    </div>
    <div
        class="animate-wiggle fixed right-[8%] bottom-[20%] z-10 text-[4rem]"
        style="animation-delay: 0.5s"
    >
        🦊
    </div>
    <div class="fixed top-[25%] left-[8%] z-10 animate-bounce text-[4rem]">
        🐱
    </div>
    <div
        class="fixed top-[30%] right-[10%] z-10 animate-bounce text-[4rem]"
        style="animation-delay: 1s"
    >
        🐻
    </div>
    {{-- Hero Section --}}
    <section
        class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-20"
    >
        <div class="animate-slideUp relative z-10 max-w-2xl text-center">
            <h1
                class="mb-4 text-[3.5rem] leading-tight font-black text-gray-800"
            >
                Selamat Datang di
                <span class="block text-violet-600">🎓 Belajar Yuk! 🎉</span>
            </h1>
            <p class="mb-8 text-[1.5rem] font-semibold text-gray-600">✨ Belajar Huruf, Angka & Bermain dengan Cerita Seru! ✨</p>
            {{-- 3D Open Book --}}
            <div
            ...
            >
                ...
                <div
                    ...
                    style="
                        transform: rotateX(15deg) rotateY(-6deg) rotateZ(-1deg);
                ...
                >
                    ...
                    >
                        ...
                        <div
                            ...
                            style="
                                box-shadow: -15px 20px 35px rgba(0, 0, 0, 0.35);
                            "
                        >
                            {{-- Cardboard thickness effect --}}
                            <div
                                class="absolute top-0 right-0 bottom-0 w-[4px] bg-violet-900 opacity-50"
                            ></div>
                        </div>
                        ...
                        >
                            ...
                            <div
                                class="absolute right-0 bottom-[-4px] left-0 h-[4px] rounded-bl-sm border-b border-l border-stone-400 bg-stone-300"
                            ></div>
                            {{-- Paper stack left edge --}}
                            <div
                                class="absolute top-0 bottom-0 left-[-4px] w-[4px] rounded-l-sm border-y border-l border-stone-300 bg-stone-200"
                            ></div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div
                                class="absolute top-0 bottom-0 left-4 w-[2px] bg-red-200 opacity-40"
                            ></div>
                            {{-- Content --}}
                            <div
                                class="relative z-10 flex h-full flex-col items-center justify-between pt-2 text-center"
                            >
                                <div
                                    class="mb-1 rounded-full bg-amber-100 px-3 py-1 text-xs font-bold tracking-wider text-amber-800 uppercase"
                                >
                                    📖 Mari Belajar
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="flex h-9 w-9 items-center justify-center rounded-full bg-blue-50 text-[1.8rem] font-extrabold text-blue-500 shadow-sm"
                                            >1</span
                                        >
                                        <span
                                            class="flex h-9 w-9 items-center justify-center rounded-full bg-violet-50 text-[1.8rem] font-extrabold text-violet-500 shadow-sm"
                                            >2</span
                                        >
                                        <span
                                            class="flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-[1.8rem] font-extrabold text-orange-500 shadow-sm"
                                            >3</span
                                        >
                                    </div>
                                </div>
                                <div class="w-full">
                                    <p class="text-sm leading-tight font-extrabold text-stone-700 md:text-base">"Membaca, menulis, & bermain dengan seru!"</p>
                    ...
                    >
                        ...
                        >
                            {{-- Cardboard thickness effect --}}
                            <div
                                class="absolute top-0 bottom-0 left-0 w-[4px] bg-violet-900 opacity-50"
                            ></div>
                        </div>
                        ...
                        >
                            {{-- Paper stack bottom edge --}}
                            <div
                                class="absolute right-0 bottom-[-4px] left-0 h-[4px] rounded-br-sm border-r border-b border-stone-400 bg-stone-300"
                            ></div>
                            {{-- Paper stack right edge --}}
                            <div
                                class="absolute top-0 right-[-4px] bottom-0 w-[4px] rounded-r-sm border-y border-r border-stone-300 bg-stone-200"
                            ></div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                <div
                                    class="mb-1 rounded-full bg-violet-100 px-3 py-1 text-xs font-bold tracking-wider text-violet-800 uppercase"
                                >
                                    🎮 Ayo Main
                                </div>
                                <div
                                    class="flex flex-grow flex-col items-center justify-center py-2"
                                >
                                    <h3
                                        class="mb-1 animate-pulse text-lg font-black text-violet-600 md:text-xl"
                                    >
                                        Game Abjad & Warna!
                                    </h3>
                                    <p class="px-2 text-xs leading-relaxed font-semibold text-stone-600 md:text-sm">Asah otak dengan tebak huruf, susun kata, dan tebak warna balon yang seru!</p>
                                </div>
                                <div class="w-full">
                                    <div
                                        class="mb-1 flex animate-bounce items-center justify-center gap-1 text-sm font-extrabold text-violet-500"
                                    >
    ...
    <section class="bg-white px-5 py-20">
        <h2 class="mb-10 text-center text-[2.5rem] font-black text-gray-800">
            🎯 Apa yang Kamu Dapatkan? 🎯
        </h2>
        <div class="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
            <div
                class="rounded-3xl border-4 border-white bg-gradient-to-br from-gray-50 to-white p-8 text-center shadow-xl transition-all hover:-translate-y-2 hover:border-violet-300"
            >
                <div class="mb-4 text-[4rem]">🔤</div>
                <h3 class="mb-3 text-[1.3rem] font-extrabold text-gray-800">
                    Huruf A-Z
                </h3>
    ...
    {{-- Stats Section --}}
    <section
        class="bg-gradient-to-r from-violet-500 to-purple-400 px-5 py-16 text-center"
    >
