    ...
    <div class="relative  w-full max-w-xl  overflow-auto flex flex-col justify-between gap-10  ">
        ...
        @else
            <div class="fixed z-20 bottom-4 left-1/2 -translate-x-1/2 flex gap-2 ">
                <div
                    class="bg-[#facc15] border-2 border-black rounded-xl px-5 py-0.5 shadow-[2px_2px_0px_rgba(0,0,0,1)]">
                ...
                @if ($lang_on)
                    <div
                        class="bg-white border-2 border-black rounded-xl px-5 py-0.5 shadow-[2px_2px_0px_rgba(0,0,0,1)]">
        ...
        <div id="flashOverlay"
           ...
           -translate-y-4 opacity-0 transition-all duration-300">
            <div id="flashBox"
                class="flex min-w-45 max-w-[90vw] items-center justify-center gap-3
               rounded-2xl border-4 border-black px-6 py-3
               shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                <span id="flashIcon" class="shrink-0 text-3xl leading-none">
                    ✅
                </span>

                <span id="flashText" class="text-center text-base font-black leading-tight text-white sm:text-lg">
                    Benar!
                </span>
            </div>
        </div>
