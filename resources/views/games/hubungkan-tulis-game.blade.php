    ...
    <script>
        ...
        function renderBoard() {
            ...
            shuffle(items).forEach(item => {
                ...
                div.className = 'item-box border-4 border-purple-200 rounded-2xl p-4 cursor-pointer transition-all shadow-md flex flex-col items-center justify-center gap-2 h-32';
        ...
        function setupSpelling(rightEl, word, audioSrc) {
            ...
            letters.forEach(ch => {
                ...
                btn.textContent = ch;
                btn.className = 'spell-tile bg-blue-50 text-blue-600 border-2 border-blue-200 w-12 h-12 rounded-lg font-black text-2xl';
                btn.onclick = (e) => {
                    e.stopPropagation();
