...
<div class="celebration" id="celebration">
    ...
    <button onclick="restartGame()"
            class="bg-gradient-to-r from-violet-500 to-purple-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-[1rem] md:text-[1.2rem] cursor-pointer mt-4 shadow-xl hover:scale-105 transition-all"
            style="font-family: 'Fredoka One', cursive;">🔄 Main Lagi!
    </button>
</div>
{{-- Header --}}
...
<div class="relative z-10 max-w-4xl mx-auto px-5 pb-8">
    ...
    <div class="bg-white rounded-3xl p-6 md:p-8 shadow-xl mb-6">
        <div class="w-36 h-36 md:w-44 md:h-44 rounded-full mx-auto mb-4 flex items-center justify-center text-[4rem] md:text-[5rem] shadow-xl transition-all duration-300 border-8 border-white"
             id="colorCircle">🍎
        </div>
        ...
        <div class="flex justify-center gap-3 md:gap-5 mt-6 flex-wrap">
            <button onclick="prevColor()"
                    class="bg-gradient-to-r from-red-400 to-red-300 text-white px-5 md:px-8 py-3 md:py-4 rounded-full font-bold text-[1rem] md:text-[1.2rem] cursor-pointer shadow-lg hover:-translate-y-1 hover:scale-105 transition-all flex items-center gap-2"
                    style="font-family: 'Fredoka One', cursive;">◀️ Sebelumnya
            </button>
            <button onclick="nextColor()"
                    class="bg-gradient-to-r from-teal-400 to-cyan-300 text-white px-5 md:px-8 py-3 md:py-4 rounded-full font-bold text-[1rem] md:text-[1.2rem] cursor-pointer shadow-lg hover:-translate-y-1 hover:scale-105 transition-all flex items-center gap-2"
                    style="font-family: 'Fredoka One', cursive;">Selanjutnya ▶️
            </button>
        </div>
        {{-- Progress --}}
        <div class="bg-white/30 rounded-full h-4 mt-5 overflow-hidden">
            <div class="h-full bg-gradient-to-r from-yellow-300 to-teal-400 rounded-full transition-all duration-500 flex items-center justify-end pr-3 text-xs font-bold text-gray-800"
        ...
        {{-- Sound Button --}}
        <button onclick="speakColor()"
                class="block mx-auto mt-4 bg-gradient-to-r from-violet-500 to-purple-400 text-white px-5 md:px-8 py-3 md:py-4 rounded-full font-bold text-[1rem] md:text-[1.2rem] cursor-pointer shadow-lg hover:-translate-y-1 hover:scale-105 transition-all"
                style="font-family: 'Fredoka One', cursive;">🔊 Dengarkan Warna
        </button>
    </div>
</div>
<style>
