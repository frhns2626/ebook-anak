<x-layout-game title="{{ $judul }}">
    ...
    <main class="relative z-10 mx-auto max-w-4xl p-6">
        ...
        <div class="mb-6">
            <div class="flex snap-x snap-mandatory scrollbar-thin scrollbar-thumb-green-300 scrollbar-track-transparent gap-4 overflow-x-auto scroll-smooth pb-4">
                @foreach ($items as $index => $item)
                    ...
                    >
                        ...
                        <h3 class="mb-1 text-xl font-black text-gray-800" style="font-family: 'Fredoka One', cursive">
                            {{ $item['name'] }}
                        </h3>
        ...
        <div id="itemDisplay" class="mb-6 hidden rounded-3xl bg-white p-8 text-center shadow-2xl">
            ...
            <p class="mb-6 text-[1.2rem] text-gray-500" id="itemHint">
                Huruf Vokal A - Ayam! Ayam berkokok di pagi hari! 🐔
            </p>
    ...
    <script>
        ...
        items.sort((a, b) => {
            const vocalCompare = vocalOrder.indexOf(a.vocal) - vocalOrder.indexOf(b.vocal);
