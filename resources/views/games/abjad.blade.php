...
<body class="min-h-screen overflow-x-hidden">
    ...
    <div class="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        >
        <span
            class="animate-float2 absolute text-[3rem] opacity-25 blur-[1px]"
            style="top: 8%; right: 3%"
            >🐶</span
        >
        <span
            class="animate-float3 absolute text-[4rem] opacity-25 blur-[1px]"
            style="top: 20%; left: 8%"
            >🐰</span
        >
        <span
        ...
        >
        <span
            class="animate-float2 absolute text-[3.5rem] opacity-25 blur-[1px]"
    ...
    {{-- Sun rays --}}
    <div
        class="pointer-events-none fixed -top-[50px] -right-[50px] z-0 h-[200px] w-[200px] rounded-full bg-gradient-to-b from-yellow-400 to-transparent opacity-30"
    ></div>
    {{-- Grass at bottom --}}
    <div
        class="pointer-events-none fixed bottom-0 left-0 z-0 h-20 w-full bg-gradient-to-t from-green-400/30 to-transparent"
    ></div>
    {{-- Main content --}}
    <main class="relative z-10 p-6">
        {{-- Header --}}
        <div
            class="relative z-20 mx-auto mb-6 max-w-4xl rounded-2xl bg-gradient-to-r from-red-400 to-orange-400 p-5 text-center shadow-lg"
        >
            <a
                href="{{ route('home') }}"
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="mb-6 rounded-3xl bg-white p-6 text-center shadow-xl">
                ...
                <p
                    ...
                    style="font-family: &quot;Fredoka One&quot;, cursive"
                >🎯 Mulai dari huruf A!</p>
            </div>
            {{-- Main Display --}}
            <div
                class="mb-6 rounded-3xl bg-white p-8 text-center shadow-xl md:p-10"
            >
                <div
                ...
                <p class="mb-4 text-[1.1rem] text-gray-600 md:text-[1.3rem]" id="letterDescription">Huruf A seperti... Apel 🍎</p>
                {{-- Controls --}}
            ...
            <div class="mb-6 rounded-3xl bg-white p-6 shadow-xl">
                <h3
                    class="mb-4 text-center text-[1.1rem] font-bold text-gray-700 md:text-[1.3rem]"
                >
                    📝 Pilih Huruf:
                </h3>
                <div
                    id="letterGrid"
                    class="grid grid-cols-6 justify-center gap-2 md:grid-cols-9 md:gap-3"
                ></div>
            </div>
            {{-- Score Section --}}
            <div
                class="rounded-3xl bg-gradient-to-r from-yellow-200 to-amber-200 p-6 text-center shadow-xl"
            >
                <h3
                ...
                <div class="flex justify-center gap-8">
                    <div class="text-center">
                        ...
                        <div class="text-sm text-amber-800 md:text-base">
                            ✅ Benar
                        </div>
                    </div>
                    <div class="text-center">
    ...
    <script>
        ...
        function selectLetter(letter) {
            ...
            document.getElementById("progressText").textContent =
                `🎯 Huruf ${letter} dari 26`
            document.getElementById("progressFill").style.width =
                `${((alphabet.indexOf(letter) + 1) / 26) * 100}%`
        }
        ...
        function checkAnswer(spoken) {
            ...
            if (spoken === currentLetter) {
                ...
                feedback.textContent =
                    "🎉 Sangat bagus! Kamu mengucapkan huruf " +
                    currentLetter +
                    " dengan benar!"
            } else {
                wrongCount++
