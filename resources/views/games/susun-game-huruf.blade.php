...
<main class="relative z-10 p-6 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="bg-white rounded-3xl p-6 md:p-8 text-center shadow-xl max-w-md w-full mb-6 relative">
        ...
        <h1 class="text-violet-600 text-[2rem] md:text-[2.5rem] font-bold mb-3" style="font-family: 'Fredoka One', cursive;">🔤 {{ $judul }}</h1>
        <p class="text-gray-500 text-[1rem] md:text-[1.1rem]">{{ $deskripsi }}</p>
    </div>
    <div class="bg-white rounded-3xl p-8 md:p-10 text-center shadow-2xl max-w-lg w-full">
        <div class="text-[5rem] md:text-[6rem] mb-3 animate-bounce" id="emoji-display">{{ $items[0]['emoji'] }}</div>
