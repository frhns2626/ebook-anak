    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="z-10  text-center">
            <h1
                ...
                style="color:#fbbf24; -webkit-text-stroke:1.5px #000; paint-order: stroke fill; filter: drop-shadow(2px 2px 0px rgba(0,0,0,0.8));"
            >
                Ayo coba baca lagi !
            </h1>
        </div>
        <!-- Tabel / Grid Suku Kata (5 Kolom x 11 Baris) -->
        <div class="my-auto grid grid-cols-5 items-center justify-items-center gap-2 text-center ">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                function playAudio(src, el) {
                    ...
                    if (el) el.classList.add('drop-shadow-[0_0_10px_rgba(74,222,128,0.9)]');
                }

                document.querySelectorAll('.suku-kata').forEach(el => {
                    el.addEventListener('click', () => playAudio(el.dataset.audio, el));
                });

                const pembukaan = document.getElementById('pembukaanAudio');
                if (pembukaan) {
                    pembukaan.addEventListener('click', () => playAudio(pembukaan.dataset.audio, null));
                }
            });
        </script>
    @endpush
