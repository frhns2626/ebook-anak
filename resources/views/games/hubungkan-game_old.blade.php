<x-layout-game title="{{ $judul }}" halaman="{{ $halaman }}">
    <main class="relative z-10 mx-auto max-w-4xl p-6">
        ...
        >
            ...
            <span class="text-sm"
                >Garis akan muncul menghubungkan huruf dan hewan.</span
            >
        </div>
        <div id="board" class="relative rounded-3xl bg-white p-6 shadow-xl">
            ...
            <div
                class="relative grid grid-cols-2 gap-20 md:gap-32"
                style="z-index: 2"
            >
                <div>
                    <h3
    ...
    <script>
        ...
        function renderBoard() {
            ...
            shuffle([...items]).forEach((item) => {
                ...
                div.dataset.id = item.id
                div.className =
                    "item-box border-4 border-purple-200 rounded-2xl p-5 cursor-pointer transition-all shadow-md flex items-center justify-center gap-4 h-24"
