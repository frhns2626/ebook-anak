<x-layout-game title="{{ $judul }}" halaman="{{ $halaman }}">
    <main class="relative z-10 mx-auto max-w-4xl p-6">
        ...
        >
            🎯
            <strong
                >Tap gambarnya, lalu tap suku kata yang cocok untuk melengkapi
                "ba"!</strong
            >
        </div>
        <div id="board" class="relative rounded-3xl bg-white p-6 shadow-xl">
            ...
            <div
                class="relative grid grid-cols-2 gap-20 md:gap-36"
                style="z-index: 2"
            >
                <div>
                    <h3
                        class="mb-3 text-center text-lg font-bold text-gray-700 md:text-xl"
                    >
                        Gambar
                    </h3>
        ...
        function checkWin() {
            ...
            if (allCorrect) {
                statusEl.textContent =
                    "🎉 Bagus! Semua kata sudah tersambung dengan benar."
                setTimeout(
                    () =>
                        document
                            .getElementById("successModal")
