...
<body>
    ...
    <main class="relative z-10 p-6 min-h-screen flex flex-col items-center justify-center">
        ...
        <div class="bg-white rounded-3xl p-8 md:p-10 text-center shadow-2xl max-w-lg w-full">
            ...
            <button onclick="nextQuestion()" class="mt-5 bg-gradient-to-r from-blue-500 to-blue-700 text-white px-6 md:px-8 py-3 md:py-4 text-[1rem] md:text-[1.2rem] rounded-full font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-all" style="font-family: 'Fredoka One', cursive;">➡️ Soal Lain</button>
        </div>
    </main>
