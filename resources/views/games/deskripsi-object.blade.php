<x-layout-game title="{{ $judul }}" halaman="{{ $halaman }}">
    ...
    <div class="flex w-full items-center justify-around">
        <img
            src="{{ $item['emoji'] }}"
            alt="{{ $item['id'] }}"
            class="baca-text relative mr-2 h-auto w-96 rounded-lg object-contain"
    ...
    <div
        class="custom-card flex w-full flex-col space-y-6 px-6 py-8 text-center text-xl shadow-sm"
    >
