...
<main class="relative z-10 p-6 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="bg-white rounded-3xl p-8 md:p-10 text-center shadow-2xl max-w-lg w-full">
        ...
        <div class="min-h-[70px] border-4 border-dashed border-violet-500 rounded-2xl mb-6 flex items-center justify-center text-[2rem] md:text-[2.5rem] font-bold text-violet-600 bg-violet-50"
             id="answer-box" style="font-family: 'Fredoka One', cursive;"></div>
        ...
        <div class="flex justify-center gap-3 md:gap-4 flex-wrap">
            <button onclick="checkAnswer()"
                    class="bg-gradient-to-r from-green-500 to-green-600 text-white px-5 md:px-8 py-3 md:py-4 text-[1rem] md:text-[1.2rem] rounded-full font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-all"
                    style="font-family: 'Fredoka One', cursive;">✅ Cek Jawaban
            </button>
            <button onclick="resetLetters()"
                    class="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-5 md:px-8 py-3 md:py-4 text-[1rem] md:text-[1.2rem] rounded-full font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-all"
                    style="font-family: 'Fredoka One', cursive;">🔄 Ulangi
            </button>
            <button onclick="nextWord()"
                    class="bg-gradient-to-r from-violet-500 to-purple-500 text-white px-5 md:px-8 py-3 md:py-4 text-[1rem] md:text-[1.2rem] rounded-full font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-all"
                    style="font-family: 'Fredoka One', cursive;">➡️ Kata Lain
            </button>
        </div>
