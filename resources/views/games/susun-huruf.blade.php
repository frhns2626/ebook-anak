...
<body
    class="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100"
>
    ...
    >
        ...
        >
            ...
            <p class="text-[1rem] text-gray-500 md:text-[1.1rem]">Klik huruf untuk menyusun kata yang benar!</p>
        </div>
        <div
            class="w-full max-w-lg rounded-3xl bg-white p-8 text-center shadow-2xl md:p-10"
        >
            <div
                class="mb-3 animate-bounce text-[5rem] md:text-[6rem]"
                id="emoji-display"
            >
                🍎
            </div>
            ...
            ></div>
            <div
                class="mb-6 flex flex-wrap justify-center gap-2 md:gap-3"
    ...
    <script>
        ...
        function initGame() {
            ...
            document.getElementById("result").className =
                "mt-5 text-[1.3rem] md:text-[1.5rem] font-bold"
        ...
        function checkAnswer() {
            ...
            if (answer === currentWord.word) {
                ...
                result.className =
                    "mt-5 text-[1.3rem] md:text-[1.5rem] font-bold text-green-500 animate-popIn"
                answerBox.className =
                ...
                result.className =
                    "mt-5 text-[1.3rem] md:text-[1.5rem] font-bold text-red-500 animate-popIn"
                answerBox.className =
        ...
        function resetLetters() {
            ...
            document.getElementById("result").textContent = ""
            document
                .querySelectorAll("#letters-container button")
                .forEach((btn) => {
                    btn.disabled = false
                    btn.className =
