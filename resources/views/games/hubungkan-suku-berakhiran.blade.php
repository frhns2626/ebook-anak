    ...
    <main class="relative z-10 mx-auto max-w-4xl p-6">
        ...
        <div id="board" class="relative rounded-3xl bg-white p-6 shadow-xl">
            ...
            <div class="relative grid grid-cols-2 gap-16 md:gap-28" style="z-index: 2">
                <div>
                    <h3 class="mb-4 text-center text-xl font-bold text-gray-700">Kata</h3>
                    <div id="pictures" class="space-y-4"></div>
                </div>
                <div>
                    <h3 class="mb-4 text-center text-xl font-bold text-gray-700">Akhiran</h3>
        ...
        <div class="mt-6 rounded-2xl bg-white p-4 shadow-lg">
            <div class="mb-2 flex items-center justify-between">
                ...
                <span id="groupProgressText" class="text-sm font-bold text-blue-500">1 / 0</span>
            </div>
