...
<body>
    ...
    <div
        ...
        style="
            top: 22%;
            right: 6%;
            animation: bounce 4s ease-in-out infinite 1.5s;
        "
    >
        🐱
    </div>
    ...
    <div
        ...
        style="
            top: 40%;
            right: 5%;
            animation: wiggle 6s ease-in-out infinite 2s;
        "
    >
        🦋
    </div>
    ...
    <main class="relative z-10 mx-auto max-w-6xl p-8">
        {{-- Header --}}
        <div
            class="relative mb-8 overflow-hidden rounded-3xl bg-white p-8 text-center shadow-xl"
        >
            <div
                class="header-rainbow absolute top-0 right-0 left-0 h-1.5"
            ></div>
            <span class="mb-3 block animate-bounce text-[3.5rem]">🎮🎮🎮</span>
            <h1
                class="mb-2 text-[2.2rem] font-bold text-gray-800"
        ...
        <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
                <span
                    class="animate-wiggle mb-4 block text-[5rem]"
                    style="color: #f472b6"
                    >🔤</span
                >
                <span
                    class="mb-3 inline-block rounded-full bg-gradient-to-r from-yellow-400 to-orange-400 px-4 py-1.5 text-[0.85rem] font-bold text-white"
                    >🔥 SEDANG</span
                >
                <h3
                    class="mb-3 text-[1.4rem] font-bold text-gray-800"
                    style="font-family: &quot;Fredoka One&quot;, cursive"
                >
                    Susun Huruf ABC 📝
                </h3>
                <p class="mb-5 text-[1rem] leading-relaxed text-gray-500">Klik huruf untuk menyusun kata yang benar! A-P-E-L = ...? 🤔💡</p>
                <button
            ...
            >
                <span
                    class="animate-wiggle mb-4 block text-[5rem]"
                    style="animation-delay: 0.3s; color: #fbbf24"
                    >🔢</span
                >
                <span
                    class="mb-3 inline-block rounded-full bg-gradient-to-r from-red-400 to-red-600 px-4 py-1.5 text-[0.85rem] font-bold text-white"
                    >💪 AGAK SULIT</span
                >
                <h3
                    class="mb-3 text-[1.4rem] font-bold text-gray-800"
                ...
                <p class="mb-5 text-[1rem] leading-relaxed text-gray-500">Klik angka sesuai jumlah benda! Berapa🍌🍌🍌? Hitung yuk! 🧮</p>
                <button
                    class="inline-flex cursor-pointer items-center gap-2 rounded-full border-none bg-gradient-to-r from-red-400 to-orange-400 px-8 py-4 text-[1.1rem] font-bold text-white shadow-lg transition-transform hover:scale-110"
                    style="font-family: &quot;Fredoka One&quot;, cursive"
                >
            ...
            >
                <span
                    class="animate-wiggle mb-4 block text-[5rem]"
                    style="animation-delay: 0.6s; color: #a78bfa"
                    >🔤</span
                >
                <span
                    class="mb-3 inline-block rounded-full bg-gradient-to-r from-green-400 to-emerald-500 px-4 py-1.5 text-[0.85rem] font-bold text-white"
                    >✨ MUDAH</span
                >
                <h3
                    class="mb-3 text-[1.4rem] font-bold text-gray-800"
                ...
                <p class="mb-5 text-[1rem] leading-relaxed text-gray-500">Klik huruf yang benar! A-B-C... Yuk belajar abjad! 📖</p>
                <button
                    class="inline-flex cursor-pointer items-center gap-2 rounded-full border-none bg-gradient-to-r from-red-400 to-orange-400 px-8 py-4 text-[1.1rem] font-bold text-white shadow-lg transition-transform hover:scale-110"
                    style="font-family: &quot;Fredoka One&quot;, cursive"
                >
            ...
            >
                <span
                    class="animate-wiggle mb-4 block text-[5rem]"
                    style="animation-delay: 0.9s; color: #6ee7b7"
                    >🎨</span
                >
                <span
                    class="mb-3 inline-block rounded-full bg-gradient-to-r from-green-400 to-emerald-500 px-4 py-1.5 text-[0.85rem] font-bold text-white"
                ...
                <p class="mb-5 text-[1rem] leading-relaxed text-gray-500">Klik warna yang benar! Merah, kuning, hijau... 🏳️🌈</p>
                <button
                    class="inline-flex cursor-pointer items-center gap-2 rounded-full border-none bg-gradient-to-r from-red-400 to-orange-400 px-8 py-4 text-[1.1rem] font-bold text-white shadow-lg transition-transform hover:scale-110"
                    style="font-family: &quot;Fredoka One&quot;, cursive"
                >
