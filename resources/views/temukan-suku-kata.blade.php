...
<body class="flex min-h-screen items-center justify-center bg-gray-800 p-4">
    <!-- Frame Halaman Buku -->
    <div
        class="relative flex aspect-[1/1.41] w-full max-w-xl flex-col justify-between overflow-hidden rounded-xl border-8 border-black bg-white p-4 shadow-2xl sm:p-6"
    >
        <!-- Area Utama Bergelombang Biru Muda -->
        <div
            class="wavy-container relative flex h-full w-full flex-col justify-between overflow-hidden p-6"
        >
            <!-- Judul Aktivitas -->
            <div class="z-10 mt-2 text-center">
                <h1
                    class="title-text text-xl font-extrabold tracking-wide sm:text-2xl"
                >
                    Temukan 5 suku kata “ba”.
                </h1>
                <h2
                    class="title-text mt-1 text-xl font-extrabold tracking-wide sm:text-2xl"
                >
                    Kemudian hubungkan !
                </h2>
            </div>
            ...
            <div
                class="relative my-4 grid w-full flex-grow grid-cols-3 items-center justify-items-center gap-x-2 gap-y-4 text-center"
            >
                <!-- Baris 1 -->
                ...
                <div class="syllable c-green relative col-start-1">
                    ...
                    <span
                        class="absolute -bottom-2 left-1/2 h-2.5 w-2.5 -translate-x-1/2 rounded-full border-2 border-black bg-transparent"
                    ></span>
                </div>
