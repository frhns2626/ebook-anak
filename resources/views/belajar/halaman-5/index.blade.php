@php
$items = [
    ['id' => 'singa', 'name' => 'Singa', 'emoji' => '🦁', 'hint' => 'Singa adalah raja hutan yang gagah dan perkasa!', 'color' => 'hover:border-amber-200', 'bg' => 'bg-amber-100 text-amber-600'],
    ['id' => 'tomat', 'name' => 'Tomat', 'emoji' => '🍅', 'hint' => 'Tomat adalah buah merah yang segar dan sehat!', 'color' => 'hover:border-red-200', 'bg' => 'bg-red-100 text-red-600'],
    ['id' => 'ubi', 'name' => 'Ubi', 'emoji' => '🍠', 'hint' => 'Ubi adalah makanan tradisional yang manis dan enak!', 'color' => 'hover:border-purple-200', 'bg' => 'bg-purple-100 text-purple-600'],
    ['id' => 'vespa', 'name' => 'Vespa', 'emoji' => '🛵', 'hint' => 'Vespa adalah sepeda motor antik yang keren!', 'color' => 'hover:border-orange-200', 'bg' => 'bg-orange-100 text-orange-600'],
    ['id' => 'wortel', 'name' => 'Wortel', 'emoji' => '🥕', 'hint' => 'Wortel adalah sayur oranye yang sehat untuk mata!', 'color' => 'hover:border-yellow-200', 'bg' => 'bg-yellow-100 text-yellow-600'],
    ['id' => 'xilofon', 'name' => 'Xilofon', 'emoji' => '🎵', 'hint' => 'Xilofon adalah alat musik yang menghasilkan bunyi indah!', 'color' => 'hover:border-pink-200', 'bg' => 'bg-pink-100 text-pink-600'],
    ['id' => 'yoyo', 'name' => 'Yoyo', 'emoji' => '🪀', 'hint' => 'Yoyo adalah mainan yang bisa naik turun!', 'color' => 'hover:border-blue-200', 'bg' => 'bg-blue-100 text-blue-600'],
    ['id' => 'zebra', 'name' => 'Zebra', 'emoji' => '🦓', 'hint' => 'Zebra adalah kuda loreng dengan garis hitam putih!', 'color' => 'hover:border-gray-200', 'bg' => 'bg-gray-100 text-gray-600'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 5 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 5 - Mengenal Dunia Hewan 🦁</h1>
            <p class="text-gray-500 text-[1rem]">Mengenal macam-macam teman hewan yang lucu!</p>
        </div>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Singa</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Singa adalah raja hutan yang gagah dan perkasa!</p>
