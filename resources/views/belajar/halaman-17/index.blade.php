@php
$items = [
    ['id' => 'donat', 'name' => 'Donat', 'emoji' => '🍩', 'hint' => 'Donat adalah roti manis berbentuk lingkaran!'],
    ['id' => 'gitar', 'name' => 'Gitar', 'emoji' => '🎸', 'hint' => 'Gitar adalah alat musik petik!'],
    ['id' => 'laut', 'name' => 'Laut', 'emoji' => '🌊', 'hint' => 'Laut adalah air asin yang luas!'],
    ['id' => 'obor', 'name' => 'Obor', 'emoji' => '🔦', 'hint' => 'Obor adalah alat penerangan!'],
    ['id' => 'pasir', 'name' => 'Pasir', 'emoji' => '🏖️', 'hint' => 'Pasir adalah butiran halus di pantai!'],
    ['id' => 'senter', 'name' => 'Senter', 'emoji' => '🔦', 'hint' => 'Senter adalah alat flashlight!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 17 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 17 - Donat & Gitar 🍩</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Donat</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Donat adalah roti manis berbentuk lingkaran!</p>
