@php
$items = [
    ['id' => 'kacamata', 'name' => 'Kacamata', 'emoji' => '👓', 'hint' => 'Kacamata membantu kita melihat lebih jelas!', 'color' => 'hover:border-blue-200', 'bg' => 'bg-blue-100 text-blue-600'],
    ['id' => 'timun', 'name' => 'Timun', 'emoji' => '🥒', 'hint' => 'Timun adalah sayur hijau yang segar!', 'color' => 'hover:border-green-200', 'bg' => 'bg-green-100 text-green-600'],
    ['id' => 'kuda', 'name' => 'Kuda', 'emoji' => '🐴', 'hint' => 'Kuda adalah hewan peliharaan yang kuat!', 'color' => 'hover:border-amber-200', 'bg' => 'bg-amber-100 text-amber-600'],
    ['id' => 'terong', 'name' => 'Terong', 'emoji' => '🍆', 'hint' => 'Terong adalah sayur berwarna ungu!', 'color' => 'hover:border-purple-200', 'bg' => 'bg-purple-100 text-purple-600'],
...
<head>
    ...
    <title>Halaman 15 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 15 - Sayur & Hewan 🥕</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Kacamata</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Kacamata membantu kita melihat lebih jelas!</p>
