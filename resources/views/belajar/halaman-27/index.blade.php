@php
$items = [
    ['id' => 'bakso', 'name' => 'Bakso', 'emoji' => '🍜', 'hint' => 'Bakso adalah bola daging dalam kuah!'],
    ['id' => 'bambu', 'name' => 'Bambu', 'emoji' => '🎋', 'hint' => 'Bambu adalah tanaman keras berongga!'],
    ['id' => 'banjir', 'name' => 'Banjir', 'emoji' => '🌊', 'hint' => 'Banjir adalah air yang meluap!'],
    ['id' => 'bantal', 'name' => 'Bantal', 'emoji' => '🛏️', 'hint' => 'Bantal adalah alas kepala saat tidur!'],
    ['id' => 'panci', 'name' => 'Panci', 'emoji' => '🍳', 'hint' => 'Panci adalah alat masak dari logam!'],
    ['id' => 'pompa', 'name' => 'Pompa', 'emoji' => '🔧', 'hint' => 'Pompa adalah alat untuk memompa air!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 27 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 27 - Bakso & Panci 🍜</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Bakso</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Bakso adalah bola daging dalam kuah!</p>
