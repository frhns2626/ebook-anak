@php
$items = [
    ['id' => 'bakpao', 'name' => 'Bakpao', 'emoji' => '🥮', 'hint' => 'Bakpao adalah roti kukus isi daging!'],
    ['id' => 'bakpia', 'name' => 'Bakpia', 'emoji' => '🥮', 'hint' => 'Bakpia adalah kue khas Yogyakarta!'],
    ['id' => 'benua', 'name' => 'Benua', 'emoji' => '🌍', 'hint' => 'Benua adalah daratan luas di bumi!'],
    ['id' => 'cabai', 'name' => 'Cabai', 'emoji' => '🌶️', 'hint' => 'Cabai adalah bumbu pedas!'],
    ['id' => 'danau', 'name' => 'Danau', 'emoji' => '🏞️', 'hint' => 'Danau adalah air yang dikelilingi daratan!'],
    ['id' => 'hiu', 'name' => 'Hiu', 'emoji' => '🦈', 'hint' => 'Hiu adalah ikan predator laut!'],
    ['id' => 'koboi', 'name' => 'Koboi', 'emoji' => '🤠', 'hint' => 'Koboi adalah penunggang kuda dari Barat!'],
    ['id' => 'kue', 'name' => 'Kue', 'emoji' => '🎂', 'hint' => 'Kue adalah makanan manis untuk pesta!'],
    ['id' => 'bulberry', 'name' => 'Bulberry', 'emoji' => '🫐', 'hint' => 'Bulberry adalah buah kecil berwarna biru!'],
    ['id' => 'video', 'name' => 'Video', 'emoji' => '📹', 'hint' => 'Video adalah rekaman gambar bergerak!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 26 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 26 - Bakpao & Kue 🥮</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Bakpao</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Bakpao adalah roti kukus isi daging!</p>
