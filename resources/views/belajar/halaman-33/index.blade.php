@php
$items = [
    ['id' => 'meja', 'name' => 'Meja', 'emoji' => '🪑', 'hint' => 'Meja adalah furniture untuk meletakkan barang!'],
    ['id' => 'kue', 'name' => 'Kue', 'emoji' => '🎂', 'hint' => 'Kue adalah makanan manis untuk pesta!'],
    ['id' => 'buku', 'name' => 'Buku', 'emoji' => '📚', 'hint' => 'Buku adalah tempat menulis dan membaca!'],
    ['id' => 'udang', 'name' => 'Udang', 'emoji' => '🦐', 'hint' => 'Udang adalah makanan laut kecil!'],
    ['id' => 'sapi', 'name' => 'Sapi', 'emoji' => '🐄', 'hint' => 'Sapi adalah hewan pemakan rumput!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 33 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 33 - Meja & Buku 🪑</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Meja</h2>
