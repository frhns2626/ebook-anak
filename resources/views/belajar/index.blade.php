...
<div class="fixed inset-0 pointer-events-none z-0"
     style="background:radial-gradient(ellipse at 20% 20%, rgba(255,248,225,0.8) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(200,245,219,0.6) 0%, transparent 50%), radial-gradient(ellipse at 50% 50%, rgba(255,255,255,0.3) 0%, transparent 70%)"></div>
{{-- Floating stars --}}
...
[
    ...
    <section class="bg-white rounded-3xl p-8 shadow-xl border-4 border-white text-center">
        ...
        <a href="{{ route('belajar.halaman-1') }}"
           class="inline-flex items-center gap-3 px-10 py-5 text-[1.25rem] font-extrabold text-white bg-gradient-to-r from-violet-500 via-purple-400 to-fuchsia-400 rounded-2xl shadow-xl hover:-translate-y-1 hover:scale-102 transition-all"
