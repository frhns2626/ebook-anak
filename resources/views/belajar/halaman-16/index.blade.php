@php
$items = [
    ['id' => 'koin', 'name' => 'Koin', 'emoji' => '🪙', 'hint' => 'Koin adalah uang logam yang bulat!'],
    ['id' => 'melon', 'name' => 'Melon', 'emoji' => '🍈', 'hint' => 'Melon adalah buah manis berwarna hijau!'],
    ['id' => 'permen', 'name' => 'Permen', 'emoji' => '🍬', 'hint' => 'Permen adalah makanan manis yang lucu!'],
    ['id' => 'taman', 'name' => 'Taman', 'emoji' => '🏡', 'hint' => 'Taman adalah tempat yang ditanami bunga!'],
    ['id' => 'tim', 'name' => 'Tim', 'emoji' => '⚽', 'hint' => 'Tim adalah sekelompok pemain!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 16 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 16 - Koin & Buah 🏡</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Koin</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Koin adalah uang logam yang bulat!</p>
