@php
$items = [
    ['id' => 'manga', 'name' => 'Manga', 'emoji' => '📚', 'hint' => 'Manga adalah komik dari Jepang yang sangat seru untuk dibaca!', 'color' => 'hover:border-red-200', 'bg' => 'bg-red-100 text-red-600'],
    ['id' => 'nanas', 'name' => 'Nanas', 'emoji' => '🍍', 'hint' => 'Nanas adalah buah berwarna kuning yang asam-manis!', 'color' => 'hover:border-amber-200', 'bg' => 'bg-amber-100 text-amber-600'],
    ['id' => 'obeng', 'name' => 'Obeng', 'emoji' => '🪛', 'hint' => 'Obeng adalah alat untuk memutar sekrup!', 'color' => 'hover:border-gray-200', 'bg' => 'bg-gray-100 text-gray-600'],
    ['id' => 'paus', 'name' => 'Paus', 'emoji' => '🐋', 'hint' => 'Paus adalah hewan terbesar di lautan!', 'color' => 'hover:border-blue-200', 'bg' => 'bg-blue-100 text-blue-600'],
    ['id' => 'quran', 'name' => 'Quran', 'emoji' => '📖', 'hint' => 'Quran adalah kitab suci umat Islam!', 'color' => 'hover:border-green-200', 'bg' => 'bg-green-100 text-green-600'],
    ['id' => 'rusa', 'name' => 'Rusa', 'emoji' => '🦌', 'hint' => 'Rusa adalah hewan yang indah dengan tanduk!', 'color' => 'hover:border-orange-200', 'bg' => 'bg-orange-100 text-orange-600'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 4 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 4 - Mengenal Dunia Hewan 🦁</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Manga</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Manga adalah komik dari Jepang yang sangat seru untuk dibaca!</p>
