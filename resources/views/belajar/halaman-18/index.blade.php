@php
$items = [
    ['id' => 'asem', 'name' => 'Asem', 'emoji' => '🍋', 'hint' => 'Asem adalah rasa asam yang segar!'],
    ['id' => 'bayam', 'name' => 'Bayam', 'emoji' => '🥬', 'hint' => 'Bayam adalah sayuran hijau yang sehat!'],
    ['id' => 'botol', 'name' => 'Botol', 'emoji' => '🍶', 'hint' => 'Botol adalah tempat menyimpan minuman!'],
    ['id' => 'dimsum', 'name' => 'Dimsum', 'emoji' => '🥟', 'hint' => 'Dimsum adalah makanan khas Tiongkok!'],
    ['id' => 'eskrim', 'name' => 'Eskrim', 'emoji' => '🍦', 'hint' => 'Eskrim adalah makanan dingin manis!'],
    ['id' => 'kaos', 'name' => 'Kaos', 'emoji' => '👕', 'hint' => 'Kaos adalah pakaian untuk tubuh!'],
    ['id' => 'kapas', 'name' => 'Kapas', 'emoji' => '☁️', 'hint' => 'Kapas adalah bahan untuk membuat kain!'],
    ['id' => 'kubis', 'name' => 'Kubis', 'emoji' => '🥬', 'hint' => 'Kubis adalah sayuran hijau bulat!'],
    ['id' => 'meses', 'name' => 'Meses', 'emoji' => '🍫', 'hint' => 'Meses adalah coklat meses untuk roti!'],
    ['id' => 'pompom', 'name' => 'Pom Pom', 'emoji' => '🎀', 'hint' => 'Pom pom adalah aksesoris rambut!', 'color' => 'hover:border-pink-200', 'bg' => 'bg-pink-100 text-pink-600'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 18 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 18 - Sayuran & Buah 🥬</h1>
            <p class="text-gray-500 text-[1rem]">Mengenal macam-macam!</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
            @foreach($items as $index => $item)
            <div class="bg-white rounded-3xl p-6 shadow-xl text-center cursor-pointer hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group border-4 border-transparent" onclick="selectItem('{{ $item['id'] }}')">
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Bayam</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Bayam adalah sayuran hijau yang sehat!</p>
