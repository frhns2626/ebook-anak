@php
$items = [
    ['id' => 'gajah', 'name' => 'Gajah', 'emoji' => '🐘', 'hint' => 'Gajah adalah hewan darat terbesar dengan belalai!', 'color' => 'hover:border-gray-200', 'bg' => 'bg-gray-100 text-gray-600'],
    ['id' => 'helicopter', 'name' => 'Helicopter', 'emoji' => '🚁', 'hint' => 'Helicopter adalah pesawat yang bisa terbang tinggi!', 'color' => 'hover:border-blue-200', 'bg' => 'bg-blue-100 text-blue-600'],
    ['id' => 'ikan', 'name' => 'Ikan', 'emoji' => '🐟', 'hint' => 'Ikan adalah hewan yang hidup di air!', 'color' => 'hover:border-cyan-200', 'bg' => 'bg-cyan-100 text-cyan-600'],
    ['id' => 'jerapah', 'name' => 'Jerapah', 'emoji' => '🦒', 'hint' => 'Jerapah adalah hewan dengan leher paling panjang!', 'color' => 'hover:border-yellow-200', 'bg' => 'bg-yellow-100 text-yellow-600'],
    ['id' => 'kelelawar', 'name' => 'Kelelawar', 'emoji' => '🦇', 'hint' => 'Kelelawar adalah satu-satunya mamalia yang bisa terbang!', 'color' => 'hover:border-purple-200', 'bg' => 'bg-purple-100 text-purple-600'],
    ['id' => 'lampu', 'name' => 'Lampu', 'emoji' => '💡', 'hint' => 'Lampu menerangi ruangan agar terang!', 'color' => 'hover:border-amber-200', 'bg' => 'bg-amber-100 text-amber-600'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 3 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 3 - Mengenal Dunia Hewan 🦁</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Gajah</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Gajah adalah hewan darat terbesar dengan belalai!</p>
