@php
$items = [
    ['id' => 'robot', 'name' => 'Robot', 'emoji' => '🤖', 'hint' => 'Robot adalah mesin yang bisa bekerja otomatis!'],
    ['id' => 'lilin', 'name' => 'Lilin', 'emoji' => '🕯️', 'hint' => 'Lilin adalah alat penerangan dari wax!'],
    ['id' => 'mobil', 'name' => 'Mobil', 'emoji' => '🚗', 'hint' => 'Mobil adalah kendaraan bermotor ber roda empat!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 25 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 25 - Robot & Mobil 🤖</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Robot</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Robot adalah mesin yang bisa bekerja otomatis!</p>
