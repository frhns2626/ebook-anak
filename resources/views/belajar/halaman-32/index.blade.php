@php
$items = [
    ['id' => 'gunung', 'name' => 'Gunung', 'emoji' => '🏔️', 'hint' => 'Gunung adalah dataran tinggi yang besar!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 32 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <div class="fixed z-10 pointer-events-none animate-float-gentle" style="bottom:22%;right:4%">🏔️</div>
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <span class="text-[3rem] mb-2 block animate-bounce-subtle">🏔️</span>
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 32 - Gunung 🏔️</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            <div class="text-[8rem] md:text-[10rem] mb-4 animate-pop" id="itemEmoji">🏔️</div>
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Gunung</h2>
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Gunung adalah dataran tinggi yang besar!</p>
