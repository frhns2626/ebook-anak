@php
$items = [
    ['id' => 'tomat', 'name' => 'Tomat', 'emoji' => '🍅', 'hint' => 'Tomat adalah buah merah untuk sauce!'],
    ['id' => 'paying', 'name' => 'Paying', 'emoji' => '☂️', 'hint' => 'Paying adalah alas kepala saat tidur!'],
    ['id' => 'kelinci', 'name' => 'Kelinci', 'emoji' => '🐰', 'hint' => 'Kelinci adalah hewan berbulu yang lompat!'],
    ['id' => 'bola', 'name' => 'Bola', 'emoji' => '⚽', 'hint' => 'Bola adalah alat main bulat!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 29 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 29 - Tomat & Payung 🍅</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <h2 class="text-[2.5rem] md:text-[3rem] font-black text-gray-800 mb-2" id="itemName">Tomat</h2>
