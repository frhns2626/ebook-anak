@php
$items = [
    ['id' => 'banteng', 'name' => 'Banteng', 'emoji' => '🐂', 'hint' => 'Banteng adalah hewan liar mirip sapi!'],
    ['id' => 'mangga', 'name' => 'Mangga', 'emoji' => '🥭', 'hint' => 'Mangga adalah buah tropis manis!'],
    ['id' => 'minyak', 'name' => 'Minyak', 'emoji' => '🛢️', 'hint' => 'Minyak adalah cairan untuk memasak!'],
    ['id' => 'nyanyi', 'name' => 'Nyanyi', 'emoji' => '🎤', 'hint' => 'Nyanyi adalah mengeluarkan suara dengan irama!'],
    ['id' => 'nyenyak', 'name' => 'Nyenyak', 'emoji' => '😴', 'hint' => 'Nyenyak adalah tidur dengan nyenyak!'],
    ['id' => 'singa', 'name' => 'Singa', 'emoji' => '🦁', 'hint' => 'Singa adalah raja hutan!'],
    ['id' => 'sungai', 'name' => 'Sungai', 'emoji' => '🏞️', 'hint' => 'Sungai adalah air yang mengalir!'],
    ['id' => 'tongkat', 'name' => 'Tongkat', 'emoji' => '🏏', 'hint' => 'Tongkat adalah alat untuk menopang!'],
    ['id' => 'senyum', 'name' => 'Senyum', 'emoji' => '😊', 'hint' => 'Senyum adalah wajah bahagia!'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 28 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 28 - Singa & Mangga 🦁</h1>
        ...
        <div id="itemDisplay" class="bg-white rounded-3xl p-8 shadow-2xl text-center mb-6 hidden">
            ...
            <p class="text-gray-500 text-[1.2rem] mb-6" id="itemHint">Singa adalah raja hutan!</p>
