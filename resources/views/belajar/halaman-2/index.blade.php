@php
$items = [
    ['id' => 'ayam', 'name' => 'Ayam', 'emoji' => '🐔', 'hint' => 'Ayam adalah hewan yang bisa berkokok dan bertelur!', 'color' => 'hover:border-amber-200', 'bg' => 'bg-amber-100 text-amber-600'],
    ['id' => 'beruang', 'name' => 'Beruang', 'emoji' => '🐻', 'hint' => 'Beruang adalah hewan yang kuat dan lucu!', 'color' => 'hover:border-brown-200', 'bg' => 'bg-brown-100 text-brown-600'],
    ['id' => 'cabai', 'name' => 'Cabai', 'emoji' => '🌶️', 'hint' => 'Cabai adalah bumbu yang pedas!', 'color' => 'hover:border-red-200', 'bg' => 'bg-red-100 text-red-600'],
    ['id' => 'dasi', 'name' => 'Dasi', 'emoji' => '👔', 'hint' => 'Dasi adalah aksesoris pakaian yang keren!', 'color' => 'hover:border-blue-200', 'bg' => 'bg-blue-100 text-blue-600'],
    ['id' => 'elang', 'name' => 'Elang', 'emoji' => '🦅', 'hint' => 'Elang adalah burung yang gagah dan tinggi!', 'color' => 'hover:border-purple-200', 'bg' => 'bg-purple-100 text-purple-600'],
    ['id' => 'flamingo', 'name' => 'Flamingo', 'emoji' => '🦩', 'hint' => 'Flamingo adalah burung berwarna pink yang indah!', 'color' => 'hover:border-pink-200', 'bg' => 'bg-pink-100 text-pink-600'],
];
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Halaman 2 - Ebook Anak TK</title>
    @fonts
...
<body class="min-h-screen overflow-x-hidden">
    ...
    <main class="relative z-10 p-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-6 mb-6 shadow-xl text-center relative overflow-hidden">
            ...
            <h1 class="text-[1.8rem] md:text-[2.2rem] text-gray-800 font-black mb-1">Halaman 2 - Mengenal Dunia Hewan 🦁</h1>
