...
class Halaman2 extends Controller
{
    ...
    public function getDataPublicHalaman2(): array
    {
        ...
        $en = [
            ...
            ['id' => 'cabai', 'emoji' => asset('gambar/halaman_2/cabai.webp'), 'audio' => asset('audio/Halaman 2/3. cabai.m4a')],
            ['id' => 'dasi', 'emoji' => asset('gambar/halaman_2/dasi.webp'), 'audio' => asset('audio/Halaman 2/4. dasi.m4a')],
            ['id' => 'elang', 'emoji' => asset('gambar/halaman_2/elang.webp'), 'audio' => asset('audio/Halaman 2/5. elang.m4a')],
            ['id' => 'flamingo', 'emoji' => asset('gambar/halaman_2/flamingo.webp'), 'audio' => asset('audio/Halaman 2/6. flamingo.m4a')],
        ];
        return [
            'items' => $id,
            'total_item' => count($id),
